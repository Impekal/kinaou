...
Repo: `Impekal/kinaou`
Default branch: `main`
Current main SHA after PR #72: `a8cb091c5b549bced2044043f0eb994e8ed0d707`
...
The REAL CAPTURE path is now also merged (PR #71 worker jobs, PR #72 Capture Studio). Remaining capture follow-ups when needed: per-window capture targeting, capture region picking UI, and optional audio for recordings — none blocking. The next milestone should come from the later roadmap (avatar, adapt/publish flow, commentary/reaction) together with the pending real-Mac execution test.
