...
Next coverage: global recovery/project backup → Studio/manual editing → render/Short/course exports → Director and local generation → assets/capture/publishing. Add interaction coverage for each migrated panel, especially pending jobs, errors and drafts. Completion numbering: COMPLETION_CHECKLIST.md.
