export type WorkerCapability = 'filesystem' | 'ffmpeg' | 'media-probe' | 'asset-upload' | 'media-proxy' | 'media-thumbnail' | 'media-waveform' | 'llm' | 'image-generation' | 'video-generation' | 'screen-capture' | 'web-capture' | 'speech-to-text' | 'text-to-speech' | 'avatar'
