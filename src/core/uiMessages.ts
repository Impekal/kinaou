...
export const uiMessages = {
  ...
  'ui.partial': ['Übersetzung im Ausbau: Navigation, Projektstart und Kursformular sind übersetzt. Weitere Fachbereiche und technische Fehlermeldungen erscheinen noch auf Englisch.', 'Translation in progress: navigation, project creation and the course form are translated. Other specialist panels and technical error details remain in English.', 'Traduction en cours : la navigation, la création de projets et le formulaire de cours sont traduits. Les autres modules et détails d’erreurs techniques restent en anglais.'],
