...
export function validateCaptureRequest(value) {
  ...
  if (value.kind === 'recording') {
    ...
    return { kind: 'recording', displayId, delaySeconds, region, interactive: false, durationMs: value.durationMs }
  }
  return { kind: 'screenshot', displayId, delaySeconds, region, interactive }
}
